...
<link
	...
	rel="stylesheet">
<link rel="icon"
	href="${pageContext.request.contextPath}/assets/images/icon.png"
	type="image/png">
...
<body>
		...
		<nav class="navbar navbar-expand-lg">
			<div class="container">
				<a class="navbar-brand"
					href="controller?command=forward_command&target=homepage">
					<h2>
						Smart <em>Things</em>
					</h2>
				</a>
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					<ul class="navbar-nav ml-auto" id="navBarUL">
						<li class="nav-item active" id="nav-item-homepage"><a
							class="nav-link"
							href="controller?command=forward_command&target=homepage">${homepage}</a>
						</li>
						<li class="nav-item" id="nav-item-products"><a
							class="nav-link"
							href="controller?command=forward_command&target=products">${ourProducts}</a>
						</li>
						<li class="nav-item" id="nav-item-about"><a class="nav-link"
							href="controller?command=forward_command&target=about">${aboutUs}</a>
						</li>
						<li class="nav-item" id="nav-item-contact"><a
							class="nav-link"
							href="controller?command=forward_command&target=contact">${contactUs}</a>
						</li>
						<li class="nav-item" id="nav-item-sign-up"><a
							class="nav-link"
							href="controller?command=forward_command&target=logIn">${logIn}</a>
						</li>
						<li class="nav-item dropdown d-none" id="nav-item-dropdown-menu">
							...
							aria-expanded="false"> <img
								src="${pageContext.request.contextPath}/assets/images/avatars/0.png"
							...
							<div class="dropdown-menu"
								...
								<a class="dropdown-item" href="#">${myOrders}</a> <a
									class="dropdown-item" href="controller?command=sign_out">${logOut}</a>
	...
	<script
		src="${pageContext.request.contextPath}/assets/js/accordions.js"></script>
